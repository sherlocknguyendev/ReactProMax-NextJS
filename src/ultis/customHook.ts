...
// - 'Custom wavesurfer' hook: Để có thể xử lý logic, thao tác trực tiếp với instant wavesurfer (nếu viết trong useEffect thì k sd đc)
export const useWavesurfer = (

    containerRef: React.RefObject<HTMLDivElement>,
    options: Omit<WaveSurferOptions, 'container'>) => {
    // Omit(Bỏ sót): Để bỏ đi các thuộc tính mặc định phải có
